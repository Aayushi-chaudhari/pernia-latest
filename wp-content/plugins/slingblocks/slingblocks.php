...
if ( ! class_exists( 'SLINGBLOCKS' ) ) {
	...
	class SLINGBLOCKS {
		...
		public function enqueue_block_editor_assets() {
			...
			$assets_path = defined( 'SLINGBLOCKS_REACT_ENVIRONMENT' ) && 1 === SLINGBLOCKS_REACT_ENVIRONMENT ? plugin_dir_url( __FILE__ ) . "dist/$app_name.asset.php" : $editor_dir . "/$app_name.asset.php";
